...
| ------------------------------------------------------ | ---- | --- | -------------------------------------------------------------------- |
| [`services/local-stt`](./services/local-stt/README.md) | 8002 | STT | Zipformer-30M (vi), Parakeet-TDT final + Moonshine base partial (en) |
...
| Parakeet-TDT-0.6b-v2 en | CC-BY-4.0           | Attribution required; commercial use permitted                                    |
