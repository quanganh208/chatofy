...
/**
 * Continuous speech-to-speech, for comparison against the cascade at /translate.
 *
 * A separate page rather than a mode toggle on that one, for the same reason
 * this runs on a separate WebSocket path: the cascade page is the product, and
 * a branch inside it would put every change to this experiment one bad render
 * away from the thing being compared against. `/translate/baseline` already
 * established the pattern of a sibling page per approach.
 *
    ...
    <main className="mx-auto flex min-h-screen w-full max-w-xl flex-col gap-6 p-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            End-to-end speech translation. Unlike the main page, this does not wait for you to
            ...
            <div className="flex flex-col gap-2">
              ...
              */}
              ...
              <p className="text-muted-foreground text-xs">
                The translation trails you by about three and a half seconds — that is the model,
                not the connection.
              </p>
            </div>
          ) : null}
      ...
      <p className="text-muted-foreground text-center text-sm">
        <Link href="/translate" className="underline underline-offset-4">
          Back to the turn-based translator
        </Link>
      </p>
    </main>
  );
