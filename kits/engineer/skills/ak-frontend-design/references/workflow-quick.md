...
python3 ${CLAUDE_PLUGIN_ROOT}/skills/ak-ui-ux-pro-max/scripts/search.py "<style-keywords>" --domain style
python3 ${CLAUDE_PLUGIN_ROOT}/skills/ak-ui-ux-pro-max/scripts/search.py "<mood>" --domain typography
python3 ${CLAUDE_PLUGIN_ROOT}/skills/ak-ui-ux-pro-max/scripts/search.py "<industry>" --domain color
```
