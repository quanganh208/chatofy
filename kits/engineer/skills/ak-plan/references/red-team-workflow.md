...
Remind user they can run `/ak:plan validate {plan-directory-path}` before implementation.
When the user approves implementation, run `/ak:cook {ABSOLUTE_PATH_TO_PLAN_DIR}/plan.md`.
