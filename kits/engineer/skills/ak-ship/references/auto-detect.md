...
**If NONE:** Use `ask_user capability` — "No test runner detected. Options: A) Skip tests, B) Provide test command"
...
User explicitly says "breaking" or "major feature" → ask_user capability for minor/major
```
