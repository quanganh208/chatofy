...
- Pre-landing review (from `the engineer ship skill` pipeline)
...
For each critical issue, use `ask_user capability`:
...
## Integration with the engineer ship skill
...
## Integration with the installed code-review skill
