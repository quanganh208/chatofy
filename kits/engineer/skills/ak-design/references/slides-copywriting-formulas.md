...
python ${CLAUDE_PLUGIN_ROOT}/skills/ak-design-system/scripts/search-slides.py "problem agitation" -d copy

# Get emotion-appropriate formula
python ${CLAUDE_PLUGIN_ROOT}/skills/ak-design-system/scripts/search-slides.py "urgency cta" -d copy
```
