...
python ${CLAUDE_PLUGIN_ROOT}/skills/ak-design-system/scripts/search-slides.py "investor pitch" -d strategy

# Get emotion arc
python ${CLAUDE_PLUGIN_ROOT}/skills/ak-design-system/scripts/search-slides.py "series a funding" -d strategy --json
```
