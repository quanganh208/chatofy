...
python ${CLAUDE_PLUGIN_ROOT}/skills/ak-design-system/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python ${CLAUDE_PLUGIN_ROOT}/skills/ak-design-system/scripts/search-slides.py "traction slide" \
