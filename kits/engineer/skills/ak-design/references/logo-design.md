...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/ak-design/scripts/logo/search.py "tech startup modern" --design-brief -p "BrandName"
```
...
```bash
# Styles
python3 ${CLAUDE_PLUGIN_ROOT}/skills/ak-design/scripts/logo/search.py "minimalist clean" --domain style

# Color palettes
python3 ${CLAUDE_PLUGIN_ROOT}/skills/ak-design/scripts/logo/search.py "tech professional" --domain color

# Industry guidelines
python3 ${CLAUDE_PLUGIN_ROOT}/skills/ak-design/scripts/logo/search.py "healthcare medical" --domain industry
```
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/ak-design/scripts/logo/generate.py --brand "TechFlow" --style minimalist --industry tech
python3 ${CLAUDE_PLUGIN_ROOT}/skills/ak-design/scripts/logo/generate.py --prompt "coffee shop vintage badge" --style vintage
```
