...
| 8 Dark Luxury _(AI-authored)_ | Excellent | Premium editorial; gold-on-black layers stand out for architecture docs |
...
| 8 Dark Luxury _(AI-authored)_ | Fair        | Non-standard dark bg for UML; use only for premium editorial contexts |
...
| 8 Dark Luxury _(AI-authored)_ | Good        | Dramatic contrast; dark lifelines suit developer blogs and premium tech docs |
...
| 8 Dark Luxury _(AI-authored)_ | Good        | Striking for premium process documentation |
...
| 7 OpenAI Official             | Good                         | Clean and minimal                                                        |
| 8 Dark Luxury _(AI-authored)_ | Excellent                    | Gold accent branches on black; radial layouts stand out in presentations |
...
| 8 Dark Luxury _(AI-authored)_ | Excellent   | Color-coded data paths shine against deep black; ideal for data engineering docs |
...
| 8 Dark Luxury _(AI-authored)_ | Fair        | Stick figures less visible on deep black; use cautiously |
...
| 8 Dark Luxury _(AI-authored)_ | Good        | High contrast for state transitions; editorial quality |
...
| 8 Dark Luxury _(AI-authored)_ | Excellent | Deep black classic for infrastructure docs; gold topology lines pop |
...
| 7 OpenAI Official             | Excellent                        | Minimal, precise                                           |
| 8 Dark Luxury _(AI-authored)_ | Fair                             | Dark bg non-standard for comparison tables; use cautiously |
...
| 8 Dark Luxury _(AI-authored)_ | Good        | Premium project roadmaps and keynote presentations |
...
| 8 Dark Luxury _(AI-authored)_ | Excellent   | Best for premium AI system docs; champagne gold on deep black |
