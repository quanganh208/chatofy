...
const testCases = [
  ...
  // .venv (with dot)
  {
    ...
    input: {
      tool_name: 'Bash',
      tool_input: { command: '~/.claude/skills/.venv/bin/python3 script.py' },
    },
    expected: 'ALLOWED',
  },
  {
  ...
  },
  {
    ...
    input: {
      tool_name: 'Bash',
      tool_input: { command: './project/.venv/bin/pip install requests' },
    },
    expected: 'ALLOWED',
  },
  // venv (without dot)
  ...
  },
  {
    ...
    input: {
      tool_name: 'Bash',
      tool_input: { command: 'python3 -m venv --system-site-packages .venv' },
    },
    expected: 'ALLOWED',
  },
  {
